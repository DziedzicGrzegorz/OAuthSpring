package dziedzic.dev.oauth.config;

import dziedzic.dev.oauth.entity.RegistrationSource;
import dziedzic.dev.oauth.entity.UserEntity;
import dziedzic.dev.oauth.entity.UserRole;
import dziedzic.dev.oauth.service.UserService;
...
public class OAuth2LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        ...
        if ("google".equals(oAuth2AuthenticationToken.getAuthorizedClientRegistrationId())) {
            ...
            var user1 = userService.findByEmail(email);
